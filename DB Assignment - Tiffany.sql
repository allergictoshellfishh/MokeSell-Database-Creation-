...
(
	...
	SubCatDesc			varchar(30)		NOT NULL,
	CatID				varchar(3)		NOT NULL,
...
(
	...
	ListDateTime		smalldatetime	NOT NULL	CHECK (ListDateTime <= GETDATE() AND DATEDIFF(DAY, ListDateTime, GETDATE())<=30) ,
...
(
	...
	TeamLeaderID		varchar(4)		NOT NULL,
	-- Constraints
...
(
	...
	AwardAmt			smallmoney		NULL CHECK (AwardAmt >= 0)
...
Create TABLE Bump 
(
	BumpID				varchar(2)		CHECK(BumpID in ('O','D3','T3','D7')),
...
INSERT INTO Follower (MemberID, FollowerID, DateStarted)
VALUES 
...
VALUES
('O00001', '00001', 'L00012', 13.00, 'R', '2024-05-11 19:00:00'),
...
('O00009', '00015', 'L00011', 100.00, 'A', '2024-05-03 16:34:00'),
('O00010', '00007', 'L00005', 368.00, 'R', '2024-02-28 15:54:00'),
('O00011', '00011', 'L00040', 99.00, 'R', '2025-01-31 17:50:00'),
...
VALUES
('R00001', '2024-01-02 10:00:00', 'Very smooth process overall', 5,	NULL, NULL, 'S', 'O001'),
('R00002', '2024-01-15 09:10:00', NULL, 3, 5, 4, 'B', 'O002'),
('R00003', '2024-02-01 13:36:00', 'Item does not look like photo', 1, 3, 1, 'B', 'O003'),
('R00004', '2024-02-02 18:28:00', 'Buyer texted to change collection time last minute',	1, NULL, NULL, 'S',	'O004'),
('R00005', '2024-03-02 03:46:00', 'Seller was very helpful with answering questions', 5, 4, 5, 'B', 'O005'),
('R00006', '2024-04-02 23:20:00', NULL, 5, NULL, NULL, 'S', 'O006'),
('R00007', '2024-05-02 11:15:00', 'Slight defect in item but can be used', 4, 4, 3, 'B', 'O007'),
('R00008', '2024-05-02 19:52:00', 'I LOVE IT', 5, 5, 5, 'B', 'O008'),
('R00009', '2024-06-02 12:37:00', 'Buyer did not understand english', 1, NULL, NULL, 'S', 'O009'),
('R00010', '2024-06-02 17:04:00', 'Would buy from seller again', 4, 4, 4, 'B', 'O010'),
('R00011', '2024-07-02 08:49:00', 'Everything was okay except delivery time', 5, 3, 5, 'B', 'O011'),
('R00012', '2024-08-02 13:51:00', 'Seller took long to reply message', 2, 5, 5, 'B', 'O012'),
('R00013', '2024-08-02 20:22:00', 'Best buyer I have ever sold to', 5, NULL, NULL, 'S', 'O013'),
('R00014', '2024-09-02 07:59:00', 'Battery life of item is not good', 3, 5, 2, 'B', 'O014'),
('R00015', '2024-10-02 14:21:00', 'Extensive features which is very good useful', 4, 4, 5, 'B', 'O015'),
('R00016', '2024-11-02 06:17:00', 'Colour of item could be brighter', 5, 4, 4, 'B', 'O016'),
('R00017', '2024-11-02 15:14:00', 'Really friendly buyer and we became friends', 5, NULL, NULL, 'S', 'O017'),
('R00018', '2024-12-02 02:23:00', 'Item took 5 months to come', 2, 1, 3, 'B', 'O018'),
('R00019', '2024-12-02 21:38:00', NULL, 4, 4, 4, 'B', 'O019'),
('R00020', '2025-01-02 01:29:00', 'Bad attitude and foul language used', 1, NULL, NULL, 'S', 'O020');

-- Team Relation Data
INSERT INTO Team (TeamID, TeamName, TeamLeaderID) 
VALUES
('T001', 'Technical Support', 'S001'),
('T002', 'User Complaints', 'S002'),
('T003', 'General Enquiries', 'S003'),
('T004', 'Payment Support', 'S004'),
('T005', 'Other Enquiries', 'S005');
...
VALUES 
('F00001', 'Login failure issue', '2024-01-01 10:00:00', 'Pending', 4, 'FC001', '00001', '00002', 'S001'),
('F00002', 'Checkout page freezing', '2024-01-02 11:30:00', 'Receiving Attention', 3, 'FC002', '00003', '00004', 'S002'),
('F00003', 'Suggestion to improve UI', '2024-01-03 09:15:00', 'Completed', 5, 'FC004', '00005', '00006', 'S003'),
('F00004', 'Unable to reset password', '2024-01-04 14:00:00', 'Pending', 2, 'FC001', '00007', '00008', 'S004'),
('F00005', 'Payment not processing', '2024-01-05 16:45:00', 'Receiving Attention', 3, 'FC002', '00009', '00010', 'S005'),
...
('F00008', 'Refund request delay', '2024-01-08 12:10:00', 'Receiving Attention', 4, 'FC002', '00015', '00016', 'S008'),
('F00009', 'Slow loading time', '2024-01-09 13:30:00', 'Completed', 5, 'FC001', '00017', '00018', 'S009'),
('F00010', 'Duplicate listing issue', '2024-01-10 15:45:00', 'Pending', 2, 'FC003', '00019', '00020', 'S010'),
('F00011', 'Login timeout error', '2024-01-11 09:00:00', 'Receiving Attention', 3, 'FC001', '00021', '00022', 'S001'),
('F00012', 'Recommendation for delivery options', '2024-01-12 11:20:00', 'Completed', 5, 'FC004', '00023', '00024', 'S002'),
('F00013', 'Wrong product delivered', '2024-01-13 16:10:00', 'Pending', 3, 'FC002', '00025', '00026', 'S003'),
('F00014', 'Profile update issue', '2024-01-14 14:25:00', 'Receiving Attention', 4, 'FC001', '00027', '00028', 'S004'),
('F00015', 'Spam messages received', '2024-01-15 18:45:00', 'Completed', 5, 'FC003', '00029', '00030', 'S005'),
('F00016', 'Inquiry about promotions', '2024-01-16 08:50:00', 'Pending', 2, 'FC004', '00031', '00032', 'S006'),
('F00017', 'App crashing frequently', '2024-01-17 10:35:00', 'Receiving Attention', 3, 'FC001', '00033', '00034', 'S007'),
('F00018', 'Late delivery complaint', '2024-01-18 12:40:00', 'Completed', 4, 'FC002', '00035', '00036', 'S008'),
('F00019', 'Dark mode feature request', '2024-01-19 15:30:00', 'Pending', 5, 'FC004', '00037', '00038', 'S009'),
('F00020', 'Payment gateway error', '2024-01-20 17:15:00', 'Receiving Attention', 3, 'FC002', '00039', '00040', 'S010');
...
SELECT 
    L.SellerID,
    (SELECT COUNT(*) FROM Listing L1 WHERE L1.ListStatus = 'A' AND L1.SellerID = L.SellerID) AS 'ActiveListings',
    (SELECT COUNT(*) FROM Listing L2 WHERE L2.ListStatus = 'I' AND L2.SellerID = L.SellerID) AS 'InactiveListings',
    (SELECT COUNT(*) FROM Listing L3 WHERE L3.ListStatus = 'S' AND L3.SellerID = L.SellerID) AS 'SoldListings',
	COUNT(O.OfferID) AS TotalOffers
FROM	
	Listing L
	INNER JOIN Offer O ON L.ListingID = O.ListingID
WHERE
	L.SellerID = '00010'
GROUP BY
	L.SellerID;
...
SELECT 
    ...
    SUM(O.OfferPrice) AS 'TotalRevenue'
FROM 
    Seller S
	INNER JOIN Listing L ON S.SellerID = L.SellerID
	INNER JOIN Offer O ON L.ListingID = O.ListingID
	INNER JOIN Member M ON S.SellerID = M.MemberID
WHERE 
    O.OfferStatus = 'A'
GROUP BY 
    S.SellerID, M.MemberName
ORDER BY 
	SUM(O.OfferPrice) Desc;

-- Query 3 --
SELECT 
    M.MemberID, 
	M.MemberName,
    COUNT(F.FbkID) AS 'FeedbackCount',
    (SELECT ROUND(AVG(SatisfactionRank), 2) FROM Feedback F WHERE F.ByMemberID = M.MemberID) AS 'AverageSatisfactionRank'
FROM 
    Member M INNER JOIN Feedback F ON M.MemberID = F.ByMemberID
GROUP BY 
    M.MemberID, M.MemberName
HAVING 
    COUNT(F.FbkID) = (SELECT MAX(FeedbackCount)
	FROM (SELECT ByMemberID, COUNT(FbkID) AS FeedbackCount FROM Feedback GROUP BY ByMemberID) 
	AS FeedbackCounts);